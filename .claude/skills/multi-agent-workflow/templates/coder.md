...
Implement Phase [N], Step [X] from plans/phase-[N].md
...
1. **Read the phase plan**: Check plans/phase-[N].md for your assigned step
...
If your assigned step in plans/phase-[N].md requires more files:
