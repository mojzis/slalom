...
export default class ObstacleManager {
  ...
  update(cameraY: number, playerY: number): void {
    ...
    // Remove signs that have scrolled past (below camera viewport)
